...
The particle uses the same coordinate system as the skin, so setting its center to `Vec2(0, 1)` places it on the
judgment line.

## Checkpoint

Open the tutorial in the development server. Confirm that:
